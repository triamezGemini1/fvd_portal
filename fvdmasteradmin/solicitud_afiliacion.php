...
$fvd_delegado_sol_redirect = $fvdAppBasePath . '/fvdmasteradmin/solicitud_afiliacion.php';

$fvd_delegado_sol_tipo_requerido = 'afiliacion';
...
$fvd_page_title = 'Solicitar afiliación';
...
<div class="fvd-dash" style="max-width:40rem">
    ...
    <h1>Solicitar afiliación (revisión FVD)</h1>

    <p style="font-size:0.8125rem;color:var(--fvd-muted);margin:0 0 1rem">

        Solicita que el administrador general marque al atleta como <strong>afiliado</strong> (<code>afiliacion=1</code>) tras revisar la documentación.
    ...
    <section class="fvd-card" style="padding:12px;margin-top:10px">
        ...
        <form method="post" action="">
            ...
            <input type="hidden" name="tipo" value="afiliacion">
